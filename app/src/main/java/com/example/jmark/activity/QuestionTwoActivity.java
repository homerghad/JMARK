...
public class QuestionTwoActivity extends Activity {
    ...
    public void buttonOne(View view){
        ...
        editor.putString("answer1", myButtonNumberList.get(0));
        editor.apply();
    ...
    public void buttonTwo(View view){
        SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
        editor.putString("answer1", myButtonNumberList.get(1));
        editor.apply();
        Intent intent = new Intent(this,QuestionThreeActivity.class);
        startActivity(intent);
    }
    public void buttonThree(View view){
        SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
        editor.putString("answer1", myButtonNumberList.get(2));
        editor.apply();
        Intent intent = new Intent(this,QuestionThreeActivity.class);
        startActivity(intent);
    }
    public void buttonFour(View view){
        SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
        editor.putString("answer1", myButtonNumberList.get(3));
        editor.apply();
        Intent intent = new Intent(this,QuestionThreeActivity.class);
        startActivity(intent);
    }
    public void buttonFive(View view){
        SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
        editor.putString("answer1", myButtonNumberList.get(4));
        editor.apply();
        Intent intent = new Intent(this,QuestionThreeActivity.class);
        startActivity(intent);
    }
