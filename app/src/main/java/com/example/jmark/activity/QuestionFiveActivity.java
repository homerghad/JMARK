...
=======
    ...
    public void buttonOne(View view){
        ...
        editor.putString("answer3", myButtonNumberList.get(0));
        editor.apply();
        Intent intent = new Intent(this,AnotherChooseForMeActivity.class);
        startActivity(intent);
    }
    public void buttonTwo(View view){
        SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
        editor.putString("answer3", myButtonNumberList.get(1));
        editor.apply();
        Intent intent = new Intent(this,AnotherChooseForMeActivity.class);
        startActivity(intent);
    }
